...
needle.post(
    'http://localhost:3000/add-book', // Server endpoint
    {
...
needle.post(
    ...
    {
        // Book details to be added
        bookname: "Harry Potter and the Chamber of Secrets", // Corrected book name
        isbn: "0-7475-3849",
        author: "J.K Rowling",
        yearPublished: "1998"
    },
...
needle.get(
    'http://localhost:3000/find-by-isbn-author?isbn=978-0-7475-3269-9&author=J.K+Rowling', // Server endpoint
    // Callback function to handle response
    (err, res) => {
        if (err) {
